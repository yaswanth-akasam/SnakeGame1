...
window.addEventListener('keydown', e => {
    // Handle keyboard events (similar to your existing code)
    inputDir = { x: 0, y: 1 }; // Start the game
    moveSound.play();
...
//     console.log('upButton clicked!'); // Example action
//     inputDir.x = 0;
//     inputDir.y = -1;
// });
...
//     inputDir.x = 0;
//     inputDir.y = 1; // Example action
//   });
// rightbutton.addEventListener('click', () => {
//     console.log('rightButton clicked!'); // Example action
//     inputDir.x = 1;
//     inputDir.y = 0;
//   });
